...
```{r}
fig_div_supp <- plot_grid(plot_grid(raref_plot, diversity_plot_supp, labels = c('A', 'B'), nrow = 2),
                          plot_grid(diversity_village, diversity_season, labels = c('C', 'D', nrow = 1)),
                          nrow = 2, rel_heights = c(1, 0.5))
ggsave(plot = fig_div_supp, filename = 'figures/FigS6.png', width = 12, height = 12)
```
